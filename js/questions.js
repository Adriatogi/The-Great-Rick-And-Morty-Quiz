...
function character(total) {
  switch (total) {
    ...
    case 211:
      ...
      break;
    case 311:
      $("#process").text("Your character is Mr. Poopybutthole");
      $('#picture').prepend('<img id="poopy" src=pictures/Poopy.png />')
      $('#quote').prepend('&#8220;Oo-wee!&#8221;- Mr. Poopybutthole')
      break;
    case 121:
      $("#process").text("Your character is the Cromulons");
    ...
    case 322:
      ...
      break;
    case 132:
      $("#process").text("Your character is Unity");
      ...
      break;
    case 232:
      $("#process").text("Your character is Krombopulos Michael");
    ...
    case 123:
      ...
      break;
    case 223:
      $("#process").text("Your character is Doofus Rick");
      ...
      break;
    case 323:
      $("#process").text("Your character is Ants in my Eyes Johnson");
      ...
      break;
    case 133:
      $("#process").text("Your character is Evil Morty");
      ...
      break;
    case 233:
      $("#process").text("Your character is Revolio Clockberg, Jr.");
      ...
      break;
    case 333:
      $("#process").text("Your character is Abradolf Lincler");
...
function changeQuestion(){
  if(current ===0){
    ...
    $("#process").text("Do you value family?");
    $("#choice1").text("100%");
